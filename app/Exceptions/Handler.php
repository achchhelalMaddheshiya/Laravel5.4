...
class Handler extends ExceptionHandler
{
    ...
    public function render($request, Exception $exception)
    {
        ...
        // }
        // if ($request->wantsJson() && $exception instanceof \RuntimeException) {
        //     if ($exception->getMessage()) {
        //         return response()->json(['status' => 400, 'message' => $exception->getMessage()], 400);
        //     }
        // }

        // if ($request->wantsJson() && $exception instanceof Stripe\Error\Permission) {
        //     return response()->json(['status' => 400, 'message' => $exception->getMessage()], 400);
        // }
        ...
        //     // if ($exception->getMessage() == 'errr') {
        //     //     return response()->json(['status' => 403, 'message' => 'Please fill profile to proceed further'], 200);
        //     // }
